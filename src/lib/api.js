...
export const api = {
  ...
  getLessons: () => request('/api/app/lessons', { timeout: 20_000 }),
  getLesson: (lessonId) => request(`/api/app/lessons/${encodeURIComponent(lessonId)}`, { timeout: 20_000 }),
  createLesson: (body) => request('/api/app/lessons', { method: 'POST', body, timeout: 30_000 }),
  updateLesson: (lessonId, body) => request(`/api/app/lessons/${encodeURIComponent(lessonId)}`, { method: 'PUT', body, timeout: 30_000 }),
  deleteLesson: (lessonId) => request(`/api/app/lessons/${encodeURIComponent(lessonId)}`, { method: 'DELETE', body: {}, timeout: 20_000 }),
  getReviews: () => request('/api/app/reviews', { timeout: 20_000 }),
  createReview: (body) => request('/api/app/reviews', { method: 'POST', body, timeout: 30_000 }),
  updateReview: (reviewId, body) => request(`/api/app/reviews/${encodeURIComponent(reviewId)}`, { method: 'PUT', body, timeout: 30_000 }),
  deleteReview: (reviewId) => request(`/api/app/reviews/${encodeURIComponent(reviewId)}`, { method: 'DELETE', body: {}, timeout: 20_000 }),
